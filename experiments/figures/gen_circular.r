...
dataFilename = paste0(script.basename, "/data_circularContigs.csv")
outputFilename = paste0(script.basename, "/fig_circularContigs.png")
...
ggplot(df, aes(x=Software, y=Count, fill = Type)) +
    ...
    scale_fill_manual(values = c("olivedrab4", "olivedrab3")) +#+ theme(strip.placement = 'bottom') + #+ theme_classic() #+ theme_classic() +  
