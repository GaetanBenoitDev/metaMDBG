...
./bin/metaMDBG asm --out-dir /pasteur/appa/scratch/gbenoit/run/overlap_test_201/ --in-ont ~/appa/data/overlap_test/genome_201_50x/simulatedReads_0.fastq.gz --threads 32
