...
public:
	...
	*/
	...
	void mapReads(){
		...
		//"idée: remove contained contigs without -c, remove overlap with -c"
		...
		string command = "";
		//if(_dontOuputContigs){
		//	command = "minimap2 -x asm20 -H -DP --dual=no -I 500M -K 500M -t " + to_string(_nbCores) + " " + _inputFilename_contigs + " " + _inputFilename_contigs;
		//}
		//else{
		command = "minimap2 -x asm20 -c -H -DP --dual=no -I 100M -K 100M -t " + to_string(_nbCores) + " " + _inputFilename_contigs + " " + _inputFilename_contigs;
		//}
