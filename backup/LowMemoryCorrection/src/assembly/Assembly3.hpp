...
public:
	...
	typedef phmap::parallel_flat_hash_map<u_int32_t, vector<u_int64_t>, phmap::priv::hash_default_hash<u_int32_t>, phmap::priv::hash_default_eq<u_int32_t>, std::allocator<std::pair<u_int32_t, vector<u_int64_t>>>, 4, std::mutex> KminmerSequenceMap;
