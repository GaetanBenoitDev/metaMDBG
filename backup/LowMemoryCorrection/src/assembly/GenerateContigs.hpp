...
public:
	...
	void loadGraph(){
		...
		GraphSimplify* graphSimplify = new GraphSimplify(graphSuccessors, _inputDir, 0, _kminmerSize, _nbCores, _kminmerLengthMean, _kminmerOverlapMean, _logFile);
    ...
    //void debug_writeGfaErrorfree(unitigDatas, crushBubble, smallBubbleOnly, detectRoundabout, insertBubble, saveAllState, doesSaveUnitigGraph, MDBG* mdbg, size_t minimizerSize, size_t nbCores, bool useLocalAbundanceFilter, bool removeLongTips){
	  ...
	  //_graph->debug_writeGfaErrorfree(0, 0, -1, _kminmerSize, false, true, false, _unitigDatas, true, false, true, false, true, true, _mdbg, _minimizerSize, _nbCores, true, false);
		...
		graphSimplify->debug_writeGfaErrorfree(2000, 2000, -1, _kminmerSize, false, true, false, _unitigDatas, true, false, false, false, false, true, _mdbg, _minimizerSize, _nbCores, false, false);
		...
		_logFile << "Loading unitig graph" << endl;
		...
		_logFile << "Simplifying" << endl;

        _progressiveAbundanceFilter = new ProgressiveAbundanceFilter(unitigGraph, _inputDir, _kminmerSize, true, _kminmerSize==_kminmerSizeFirst, _logFile);
		X dummy;
