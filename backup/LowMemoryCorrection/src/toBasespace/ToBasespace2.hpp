...
public:
	...
	struct MinimizerContig{
		u_int32_t _contigIndex;
		vector<u_int64_t> _contigMinimizers;
	};
	...
	void extractAlignment(const spoa64::Alignment& alignment, u_int32_t readIndex, const vector<MinimizerType>& readMinimizers, u_int32_t contigIndex, const vector<MinimizerType>& contigMinimizers, u_int32_t nbMatches, bool isReversed){
	...
	void indexMatchingPosition(u_int64_t minimizer1, u_int64_t minimizer2, const ReadPositionMatch& readPosition, const ContigPosition& contigPosition){
