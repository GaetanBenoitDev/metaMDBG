...
public:
	...
	bool isContigAssembled(const vector<u_int32_t>& nodePath, unordered_map<u_int32_t, vector<u_int32_t>>& processedNodeNames){
	...
	*/
	...
	void generateContigs2(const string& outputFilename, const string& outputFilename_fasta){
		...
		unordered_map<u_int32_t, vector<u_int32_t>> nodeName_to_contigIndex;
