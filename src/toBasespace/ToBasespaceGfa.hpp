...
*/
class ToBasespaceGfa : public Tool{
...
public:
	...
	class IndexContigsFunctor {
		...
		IndexContigsFunctor(ToBasespaceGfa& parent) : _parent(parent){
		}
	...
	class LoadContigsFunctor {
		...
		LoadContigsFunctor(ToBasespaceGfa& parent) : _parent(parent){
		}
	...
	class AlignReadFunctor {
		...
		AlignReadFunctor(ToBasespaceGfa& parent) : _parent(parent){
	...
	*/
	...
	class SetupKminmerSequenceExtractionFunctor {
		...
		ToBasespaceGfa& _toBasespace;

		SetupKminmerSequenceExtractionFunctor(ToBasespaceGfa& toBasespace) : _toBasespace(toBasespace){
		}
	...
	*/
	...
	class ExtractKminmerSequenceFunctor{
		...
		ExtractKminmerSequenceFunctor(size_t minimizerSize, float minimizerDensity, ToBasespaceGfa& toBasespace, bool collectModel) : _toBasespace(toBasespace){
	...
	*/
	...
	class CreateBaseContigsFunctor {
		...
		CreateBaseContigsFunctor(ToBasespaceGfa& toBasespace) : _toBasespace(toBasespace){
		}
