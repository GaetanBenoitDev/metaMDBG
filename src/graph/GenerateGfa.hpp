...
public:
    ...
    void execute (){
		...
		_isRepetitiveMinimizers = Commons::loadRepetitiveMinimizers(_tmpDir);
	...
	void generateAssemblyGraph(){
		...
		_finalFilename = _outputDir + "/assemblyGraph_k" + to_string(_kminmerSize) + ".gfa";
		_finalFilenameNoSeq = _outputDir + "/assemblyGraph_k" + to_string(_kminmerSize) + ".noseq.gfa";
		_contigPathFilename = _outputDir + "/assemblyGraph_k" + to_string(_kminmerSize) + "_contigpath.tsv";
		_readPathFilename = _outputDir + "/assemblyGraph_k" + to_string(_kminmerSize) + "_readpath.tsv";
	...
	class LoadUnitigsFunctor {
		...
		LoadUnitigsFunctor(GenerateGfa& parent) : _parent(parent){
			_minimizerParser = new MinimizerParser(_parent._minimizerSize, _parent._minimizerDensity_assembly, _parent._isRepetitiveMinimizers);
